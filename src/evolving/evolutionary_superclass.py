    ...
    def train_population(self):
        ...
        for _ in prog_bar:
            ...
            for n in range(self.sampling_frequency):
                ...
                returnModel = best if returnModel is None or param.fitness(self.data_x, self.data_y, best, self.layers_size) > param.fitness(
                    self.data_x, self.data_y, returnModel, self.layers_size) else returnModel
                ...
                prog_bar.set_postfix(
                    {'Best': param.fitness(self.data_x, self.data_y, returnModel, self.layers_size), 'mu': self.mu_indivs,
